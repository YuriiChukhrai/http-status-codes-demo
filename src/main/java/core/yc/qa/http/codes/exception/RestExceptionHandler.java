...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handle IllegelRequestException
     */
    @ExceptionHandler(IllegalRequestException.class)
    protected ResponseEntity<Object> handleEntityNotFound(IllegalRequestException ex) {
    ...
    protected ResponseEntity<Object> handleEntityFound(EntityExistException ex) {
